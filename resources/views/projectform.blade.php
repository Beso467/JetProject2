                    ...
                    <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-6 max-w-lg mx-auto">
                        <form action="{{ route('store-project') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" class="form-input rounded-md shadow-sm mt-1 block w-full max-w-xs" name="projectname" id="projectname" value="{{ old('projectname') }}" required>
                            </div>
                            <div class="mb-4">
                                <label for="client_id" class="block font-medium text-sm text-gray-700">Select Project Client</label>
                                <select class="form-select rounded-md shadow-sm mt-1 block w-full max-w-xs" name="client_id" id="client_id" required>
                            ...
                            <div class="mb-4">
                                ...
                                <input type="number" class="form-input rounded-md shadow-sm mt-1 block w-full max-w-xs" name="contract_price" id="contract_price" required>
                            </div>
                            <div class="mb-4">
                                <label for="contract_status" class="block font-medium text-sm text-gray-700">Enter Project Status</label>
                                <select class="form-select rounded-md shadow-sm mt-1 block w-full max-w-xs" name="contract_status" id="contract_status" required>
                                    ...
                                    <div class="employee-scroll-container">
                                        ...
                                        <div class="employee-item">
                                            <label class="block mt-1 employee-label">
                                                <input type="checkbox" class="form-checkbox employee-checkbox employee-info employee-checkbox" name="selected_employees[]" value="{{ $employee->id }}">
                                                <span class="employee-name">{{ $employee->employee_name }}</span>
                                                <span class="employee-info">Salary: {{ $employee->employee_salary }}</span>
                                            <select name="working_hours[{{ $employee->id }}]" class="ml-2 mb-2 form-select" style="width: 10vw;">
